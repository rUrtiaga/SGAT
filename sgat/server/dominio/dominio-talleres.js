...
class Taller {
    // Forma de uso Taller('UnaCategoria','UnNombre') => Crea un taller subcategoria
    // con nombre undefined Taller('Artes
    // Manuales','Ceramica','Indigena','Tradicional') => crea taller con dos
    // subcategorias, pueden ser N
...
class Store {
    ...
    talleresPorCategoria(categoria){
        this.getTalleres.filter(taller => taller._categoria == categoria)
    }
